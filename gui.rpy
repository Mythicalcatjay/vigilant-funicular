...
define gui.idle_color = '#ebebeb'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#f5f5f5'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#d4d654'
...
define gui.text_font = "fonts/FallingSky-JKwK.otf"

## The font used for character names.
define gui.name_text_font = "fonts/FallingSkyExtrabold-redB.otf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/FallingSky-JKwK.otf"
